  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>
          1. We agree that the following persons shall occupy the following
          bedrooms during our tenancy
        </p>
        <RichEditor
      ...
      <p>
        2. We agree to the following about accessing each roommates' private
        spaces and rules around shared spaces:
      </p>
      <div>
        <RichEditor
      ...
      <p>
        ...
        <p>
          Regarding furniture and belongings in common and private areas, we
          agree that:
        </p>
      </p>
      ...
      <p>
        ...
        <p>
          from the landlord. We agree that any messages for other roommates
          will:
        </p>
      </p>
