...
const Title = () => {
  ...
  return (
    <div>
      ...
      <p>
        Please visit <a href={"http//www.tenants.bc.ca"}>www.tenants.bc.ca</a> to inform yourself
        about tenants' rights and obligations in Britsh Columbia before discussing and agreeing to
        terms with any roommates.
      </p>
      <Button
        variantColor="pink"
        onClick={() => {
